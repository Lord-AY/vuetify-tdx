          ...
          <form action="" class="form-horizontal" @submit.prevent="processForm">
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="form-box">
                  <div class="form-box-title">
                    <span style="font-size: 18px; margin-left: 10px;" class="text-uppercase">Post an Ad</span>
                  </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12">
                              ...
                              <div class="row form-group-tx form-group">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                  ...
                                  <div class="radio">
                                    <input type="text" class="form-control post-ad-input" placeholder="Ad title" v-model="ads.name" />
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row form-group-tx form-group">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <select class="form-control custom-select" v-model="ads.cid">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <select class="form-control custom-select">
                                      <option value="0" disabled>-- Select Option --</option>
                                      <option :value="item.name" v-for="(item, index) in items" :key="index">{{ item.name }}</option>
                                    </select>
                                  </div>
                                </div>
                                <div class="col-md-6"></div>
                              ...
                              <div class="row form-group-tx form-group">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                  ...
                                  <textarea class="form-control" name="example-textarea-input" rows="4" placeholder="Write a short description about the item" style="padding-top: 10px" v-model="ads.description"></textarea>
                                </div>
                              </div>
                              ...
                              <div class="row form-group-tx form-group">
                                <div class="col-sm-12 col-lg-6 col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="number" class="form-control post-ad-input" placeholder="Price" v-model="ads.amount" />
                                  </div>
                                </div>
                                <div class="col-sm-12 col-lg-6 col-md-6">
                                  <div class="checkbox checkbox-info" style="margin-top: 40px;">
                                    <label class="custom-control mt-4 custom-checkbox">
                                      <input type="checkbox" class="custom-control-input" v-model="ads.negotiable" />
                              ...
                              <div class="p-2 border mb-4 form-group">
                                ...
                                <vue-upload-multiple-image @upload-success="selectImageSuccess" @before-remove="beforeRemove" :data-images="images" dragText="Images must not exceed 2mb for each" browseText="Browse image" primaryText="Default Image" markIsPrimaryText="slide images" popupText="This image will be used as the default display image, when showing your ads"></vue-upload-multiple-image>
                              </div>
                                  ...
                                  <ul class="ad-post-details">
                                    <li class="list-ad-package" style="padding-right: 0.75rem; padding-left: 0.75rem;">
                                      <label class="custom-control custom-radio mb-2 mr-4">
                                        <input type="radio" class="custom-control-input" name="example" v-model="ads.adType" value="1" checked="" />
                                        <span class="custom-control-label">
                                          <b>Regular List</b>
                                          <span class="" style="float: right; font-size: 18px;">
                                            <span style="font-size: 14px;">(Free)
                                            </span>
                                            &#8358; 0.00</span>
                                        </span>
                                      </label>
                                    ...
                                    <li class="list-ad-package" style="padding-right: 0.75rem; padding-left: 0.75rem;">
                                      <label class="custom-control custom-radio  mb-2 mr-4">
                                        <input type="radio" class="custom-control-input" name="example" v-model="ads.adType" value="2" />
                                        <span class="custom-control-label">
                                          <b>Urgent Ad</b>
                                          <span class="" style="float: right; font-size: 18px;">&#8358; 500</span>
                                        </span>
                                      </label>
                                    </li>
                                    <li class="list-ad-package" style="padding-right: 0.75rem; padding-left: 0.75rem;">
                                      <label class="custom-control custom-radio  mb-2 mr-4">
                                        <input type="radio" class="custom-control-input" name="example" v-model="ads.adType" value="3" />
                                        <span class="custom-control-label">
                                          <b>Top Ad</b>
                                          <span class="" style="float: right; font-size: 18px;">&#8358; 1000</span>
                                        </span>
                                      </label>
                                    </li>
                                  </ul>
                              ...
                              <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                  <div class="senior-ads form-group">
                                    <div class="senior-ads-header gold" style="background-color:  #f0ad4e;">
                                      <div class="post-package-title gold">
                                        <span>Gold</span>
                                      </div>
                                      <span>&#8358;</span>
                                      <h4 style="text-align: center; font-size: 48px!important; font-weight: 500; color: #fff;">
                                        3000
                                      </h4>
                                    ...
                                    <div class="select-senior-ad">
                                      <label>
                                        <input type="radio" class="option-input radio" name="example" v-model="ads.adType" value="4" />
                                        Gold
                                      </label>
                                    </div>
                                  </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                  <div class="senior-ads">
                                    <div class="senior-ads-header premium" style="background-color: #27c781;">
                                    ...
                                    <div class="select-senior-ad">
                                      <label>
                                        <input type="radio" class="option-input radio" name="example" v-model="ads.adType" value="5" />
                                        Premium
                                      </label>
                                    </div>
                                  </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                  <div class="senior-ads">
                                    <div class="senior-ads-header hot" style="background-color: #4CAF50;">
                                      <!-- <img src="../../assets/images/ad-premium.svg " width="24px"> -->
                                    ...
                                    <div class="select-senior-ad">
                                      <label>
                                        <input type="radio" class="option-input radio" name="example" v-model="ads.adType" value="6" />
                                        Hot Sellers
                                      </label>
                                    </div>
                                  </div>
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="form-box">
                  <div class="form-box-title">
                    <span style="font-size: 18px; margin-left: 10px;">Payments</span>
                  </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                          <div class="tab-content card-body border mb-0 b-0">
                            <div class="panel panel-primary">
                              <div class=" tab-menu-heading border-0 pl-0 pr-0 pt-0">
                                <div class="tabs-menu1 ">
                                  ...
                                  <ul class="nav panel-tabs">
                                    <li>
                                      <a href="#tab5" class="active" data-toggle="tab" @click="addPayment(1)">
                                        <img src="../../assets/images/wallet.svg" height="20px" style="margin-top: -4px;" alt="" srcset="" />
                                        Wallet</a>
                                    </li>
                                    <li>
                                      <a href="#tab6" data-toggle="tab" @click="addPayment(2)">
                                        <img src="../../assets/images/master_card.png" height="20px" style="margin-top: -4px;" alt="" srcset="" />
                                        Credit/ Debit Card</a>
                                    </li>
                                    <li>
                                      <a href="#tab7" data-toggle="tab" @click="addPayment(3)">
                              ...
                              <div class="panel-body tabs-menu-body pl-0 pr-0 border-0" style="padding-top: 0px;">
                                <div class="tab-content">
                                  <div class="tab-pane active " id="tab5">
                                    <div class="form-group">
                                      <label class="form-label">Wallet ID</label>
                                      <div class="input-group">
                                        <input type="text" class="form-control post-ad-input" placeholder="Wallet ID" name="wallet_id" />
                                ...
                                <i class="fa fa-cc-mastercard"></i></button>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="number" class="form-control post-ad-input" id="name1" placeholder="PIN" name="wallet_pin" />
                                    </div>
                                  ...
                                  <div class="tab-pane " id="tab6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="name2" placeholder="First Name" name="card_name" />
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-4 ">
                                        <div class="form-group mb-0">
                                          <label class="form-label">CVV
                                            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Please Enter last 3 digits"></i></label>
                                          <input type="number" class="form-control" name="terms" />
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-lg-12" style="padding-left: 0px!important;">
              ...
              <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-12 mb-5">
