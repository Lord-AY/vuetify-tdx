      ...
      <div class="col-lg-8 col-md-12 col-md-12">
        <form
          ...
          <div class="row">
            ...
            <transition name="isHidden">
            <div class="col-sm-12 col-md-12 col-lg-12" v-show="adAmount !== 0">
              <div class="form-box">
                <div class="form-box-title">
            ...
            <div
              ...
              <div class="post-ad-submit-button">
                <button class="btn btn-primary bt-block" v-show="adAmount == 0">Post Your Ad</button>
              </div>
            </div>
          </div>
        </form>
