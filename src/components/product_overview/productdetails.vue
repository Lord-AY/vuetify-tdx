<template>
    <div class="product_details generic-wrapper">
        <div class="main-content-area clearfix" v-if="product">
            <section class="section-padding .margin-top-30 gray" style="padding-bottom: 50px; padding-top: 60px;">
                <!-- Main Container -->
                <div class="container">
                    <!-- Row -->
                    <div class="col-md-8 col-xs-12 col-sm-8">
                        <div class="heading-zone">
                            ...
                            <div class="short-history">
                                <nav aria-label="breadcrumb" class="d-none d-sm-none d-md-none d-lg-block d-xl-block">
                                    <ol class="breadcrumb breadcrumb-tx arrowed ">
                                        <li class="breadcrumb-item">
                                            <a href="https://tradexplorer.com/">Home</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="https://tradexplorer.com/">{{ product.category }}
                                            </a>
                                        </li>
                                        <li class="breadcrumb-item">
                        ...
                        <div class="singlepage-detail">
                            ...
                            <div class="content-box-grid margin-top-20">
                                ...
                                <div class="">
                                    ...
                                    <div class="tab-pane fade in active" style="margin-top: 26px!important" v-if="tab3">
                                        <h3 class="tab-title" style="display: inline-block;">
                                            Reviews
                                        </h3>
                                        <div class="viewall-similar" v-if="productcomment">
                                            <a @click="limit2 = null" v-show="limitBtn2">Show All
                                                <i class="fa fa-arrow-circle-right" style="color: #4caf50;"></i></a>
                                            <a @click="limit2 = 3" v-show="!limitBtn2">Show Less
                                                <i class="fa fa-arrow-circle-right" style="color: #4caf50;"></i></a>
                                        </div>
                                        ...
                                        <div class="row" v-for="(comment, index) in toggleComment" :key="index">
                                            <div class="col-md-12">
                                                ...
                                                <p class="review-date">
                                                    {{ daysago(format_date(comment.createdAt)) }}
                                                </p>
                                                <p class="review">
                                                    {{ comment.comment }}
                                                </p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 send-review">
                                                ...
                                                <div class="review-box">
                                                    <textarea name="" class="form-control review-form" id="" rows="3"></textarea>
                                                </div>
                                    ...
                                    <div class="tab-pane fade in active" v-if="tab4">
                                        ...
                                        <div v-if="
                        product.latitude != null && product.logitude != null
                      ">
                                            <iframe :src="
                          `https://maps.google.com/maps?q=${product.latitude},${product.logitude}&hl=es;z=14&amp;output=embed`
                        ...
                        <div class="ad-share text-center">
                            <router-link to="/referal">
                                <div data-Limit="modal" data-target=".share-ad" class="small-box col-md-3 col-sm-3 col-xs-12">
                                    <i class="fa fa-share-alt"></i>
                                    <span class="hidetext">Share</span>
                                </div>
                            </router-link>
                            <a class="small-box col-md-3 col-sm-3 col-xs-12" style="padding-left: 22px; padding-right: 22px;" href="javascript:void(0);" id="ad_to_fav" data-adid="1375">
                                <i class="fa fa-heart-o active"></i>
                                <span class="hidetext"> Add to Wishlist </span>
                            </a>
                            <a class="small-box col-md-3 col-sm-3 col-xs-12" id="ad_to_fav" data-adid="1375" @click.prevent="pustTocompare">
                                <i class="fa fa-compress"></i>
                                <span class="hidetext"> Compare </span>
                            </a>
                            <div data-target=".report-quote" data-Limit="modal" class="small-box col-md-3 col-sm-3 col-xs-12" @click.prevent="showReport(product.id, product.name)">
                                <i class="fa fa-warning" style="color: red!important;"></i>
                                <span class="hidetext" style="color: red!important;">Report</span>
                            </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="col-md-12 col-sm-12 margin-bottom-20 margin-top-20">
                                                ...
                                                <button type="button" class="btn btn-theme btn-block" id="sb_mark_it">
                                                    Submit
                                                </button>
                                            </div>
                                        </form>
                            ...
                            <div class="panel with-nav-tabs panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="tab-content">
                                        <div class="tab-pane  in active  fade" id="tab1default">
                                            ...
                                            <div class="ads-list-archive" v-show="!showLoader(similarprods)" v-for="simProduct in toggleLimit" :key="simProduct.id">
                                                <!-- Image Block -->
                                ...
                                query: {
                                  ...
                                  uid: simProduct.uid
                                                            ...
                                                            <img v-for="(image,
                                index) in simProduct.photos.slice(0, 1)" :key="index" :src="image" :alt="simProduct.name" class="img-responsive" />
                                                        </router-link>
                                                    </div>
                                                    <!-- Img Block -->
                                                </div>
                                    ...
                                    query: {
                                      ...
                                      uid: simProduct.uid
                                                        ...
                                                        <ul class="slides small-slides add_info">
                                                            <li class="similar-ads-picture-thumbnails" v-for="(photo, index) in simProduct.photos" :key="index">
                                                                <router-link :to="{
                                    path: '/productDetails',
                                    query: {
                                      id: simProduct.id,
                                      ...
                                      uid: simProduct.uid
                                                        ...
                                                        <div class="clearfix archive-history">
                                                            ...
                                                            <div class="last-updated">
                                                                Posted :
                                                                {{ daysago(format_date(simProduct.createdAt)) }}
                                                            </div>
                                                            <div class="ad-meta">
                                                                <a href="javascript:void(0);" data-adid="960" class="btn save-ad"><i class="fa fa-heart-o"></i>
                                                                </a>
                                                                <router-link :to="{
                                    path: '/productDetails',
                                    query: {
                            ...
                            <div class="row" style="margin-top: 36px!important;">
                                ...
                                <div class="col-md-3">
                                    <div class="viewall-similar" id="show-more-details" v-if="similarprods.length > 3">
                                        <a @click="limit = null" v-show="limitBtn">Show More
                                            <i class="fa fa-arrow-circle-right" style="color: #4caf50;"></i></a>
                                        <a @click="limit = 3" v-show="!limitBtn">Show Less
                                            <i class="fa fa-arrow-circle-right" style="color: #4caf50;"></i></a>
                                    </div>
                                </div>
                                <div class="col-md-5"></div>
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-12">
                        ...
                        " />
                                    ...
                                    <div class="user-information  col-md-12 ">
                                        <div class="user-name">
                                            <a class="hover-color" href="../../dealer/gavien72/index.html">
                                ...
                                <div class="btn btn-block btn-primary view-contact cusbutton" style=" font-size: 20px;" v-show="!product.tradexplorer">
                                    ...
                                    <div class="selector number" v-if="showDetails" style="color: #fff!important; font-weight: 400; cursor: pointer;" @click="showDetails = !showDetails">
                                        {{ product.seller.phone }}
                                    </div>
                                </div>
                                <div class="category-list-title" style="padding: 0;" v-if="isLoggedIn">
                                    <!-- Email Button trigger modal -->
                                    <div v-if="!isHidden">
                                        <h5 v-on:click="isHidden = !isHidden">
                                            <div class="btn btn-block btn-primary contact-seller cusbutton" style="font-size: 20px;">
                                                <i class="fa fa-commenting-o place-left"></i> Chat With
                                                Seller
                                            </div>
                                        </h5>
                                    </div>
                                    <div class="row" style="margin-top: 10px;" v-if="isHidden">
                                        <p style="font-weight: 500; margin-bottom: 6px; color: #232323;">
                                            Message &#128522;
                                        </p>
                                        <textarea class="message-box" rows="6" cols="50" v-model="message"></textarea>
                                        <h5 class="send-message">
                                            <div class="btn btn-block btn-primary send-message-button cusbutton" style="border-radius:6px; font-size: 20px;box-shadow: 0 3px 7px 0 rgba(0, 0, 0, 0.4)" @click="sendSellerMessage()">
                            ...
                            <div class="widget" style="margin-bottom: 16px;">
                                <div class="widget-heading">
                                    <h4 class="panel-title" style="text-align: center; font-size: 16px; font-weight: 600;">
        ...
        <input type="hidden" id="sticky_sb_logo_url" value="../wp-content/uploads/sites/28/2018/04/logo-2.png" />
        <input type="hidden" id="static_sb_logo_url" value="@/assets/carspot-css/wp-content/uploads/sites/28/2018/04/logo-2.png" />
...
export default {
    ...
    computed: {
        ...
        ...mapGetters("cart", ["getLoading", "getMessages", "getErrors"])
    },
    watch: {
        $route: "sync",
        getFollowing: {
    ...
    created() {
        ...
        if (this.fsingleCategory) {
            if (this.fsingleCategory.checkFields !== null) {
                this.singleCart = this.fsingleCategory.checkFields
                    .split(",")
                    .concat(this.fsingleCategory.checkFields.split(","));
            }
        }
