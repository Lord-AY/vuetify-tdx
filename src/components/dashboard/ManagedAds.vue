<template>
    <div class="card mb-0">
        <div class="card-header">
            <h3 class="card-title">My Managed Ads</h3>
        </div>
        <div class="card-body">
                                    ...
                                    <div class="media-body">
                                        <div class="card-item-desc ml-4 p-0 mt-2">
                                            <a href="#" class="text-dark">
                                                <h4 class="font-weight-semibold">Modren Kitchen</h4>
                                            </a>
                            ...
                            <td>
                                <div class="media mt-0 mb-0">
                                    ...
                                    <div class="media-body">
                                        <div class="card-item-desc ml-4 p-0 mt-2">
                                            <a href="#">
                                                <h4 class="font-weight-semibold">Villa</h4>
                                            </a>
                            ...
                            <td>
                                <div class="media mt-0 mb-0">
                                    ...
                                    <div class="media-body">
                                        <div class="card-item-desc ml-4 p-0 mt-2">
                                            <a href="#" class="text-dark">
                                                <h4 class="font-weight-semibold">2BHK Rooms</h4>
                                            </a>
                                    ...
                                    <div class="media-body">
                                        <div class="card-item-desc ml-4 p-0 mt-2">
                                            <a href="#" class="tetx-dark">
                                                <h4 class="font-weight-semibold">Laxury Rooms</h4>
                                            </a>
                            ...
                            <td>
                                <div class="media mt-0 mb-0">
                                    ...
                                    <div class="media-body">
                                        <div class="card-item-desc ml-4 p-0 mt-2">
                                            <a href="#" class="text-dark">
                                                <h4 class="font-weight-semibold">Garden House</h4>
                                            </a>
                                            <a href="#"><i class="fa fa-clock-o mr-1"></i> Nov-25-2019 , 16:54 pm</a><br>
                            ...
                            <td>
                                <div class="media mt-0 mb-0">
                                    ...
                                    <div class="media-body">
                                        <div class="card-item-desc ml-4 p-0 mt-2">
                                            <a href="#" class="text-dark">
                                                <h4 class="font-weight-semibold">Modren House</h4>
                                            </a>
                                            <a href="#"><i class="fa fa-clock-o mr-1"></i> Nov-03-2019 , 12:50</a><br>
                                            <a href="#"><i class="fa fa-tag mr-1"></i> Rent</a>
                                        </div>
